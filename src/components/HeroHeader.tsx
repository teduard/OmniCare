      ...
      >
        <div>
          <Box variant="awsui-value-large">
            ...
            <span className="gradient">personal operations.</span>
          </Box>
          <Box
            variant="h2"
          ...
          >
            ...
            <br />
            <br />
            Leverage actionable insights from a professional suite of tools to
        ...
        <Box margin={{ top: "l" }}>
          <SpaceBetween size="l">
            <img src={apps} alt="OmniCare Apps" width="300" />
