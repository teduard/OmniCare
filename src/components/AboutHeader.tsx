      ...
      <SpaceBetween size="l">
        <ContentLayout
          ...
          headerBackgroundStyle={(_mode) =>
            `center center/cover url("/OmniCare/assets/hero.jpg") no-repeat`
          }
          header={
                ...
                <Container>
                  <Box padding="s">
                    <Box
                      ...
                      padding="n"
                    >
                      About <span className="gradient">OmniCare</span>
                    </Box>
        ...
        <h1>
          In an era of fragmented apps and scattered data, OmniCare provides a
